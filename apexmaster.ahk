...
$*LButton::
    ...
    if (is_single_mode && current_weapon_type != PROWLER_FULLAUTO_WEAPON_TYPE && !IsSingleFireWeapon())
        return
...
IsSingleFireWeapon()
{
    return current_weapon_type == P2020_WEAPON_TYPE || current_weapon_type == HEMLOK_WEAPON_TYPE || current_weapon_type == PROWLER_FULLAUTO_WEAPON_TYPE
}
